import { evaluationErrorDefinitions, evaluationErrorDescriptions, evaluationErrorLegend } from "./evaluationPresentation.js";
...
export function EvaluationErrorLegend({ filter = "" }) {
  ...
  return (
    <div className="evaluation-box-legend" aria-label="错误框线型说明">
      {filter && <p className="evaluation-box-legend-current">{evaluationErrorDescriptions[filter]}</p>}
