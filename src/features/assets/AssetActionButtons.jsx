...
export function AssetActionButtons({ resource, onShare, onPublic, downloadHref = "", onDownload }) {
  return (
    <div className="asset-actions">
      <button title="查看"><Eye size={13} /></button>
      {downloadHref && <button title="下载资产" onClick={() => { if (onDownload) onDownload(resource); else { const anchor = document.createElement("a"); anchor.href = downloadHref; anchor.click(); } }}><Download size={13} /></button>}
