...
required=(start.sh stop.sh status.sh backup.sh restore.sh diagnose.sh compose.yml compose.gpu.yml env.example VERSION SOURCE_COMMIT SHA256SUMS images/offline-images.tar.gz db/schema.sql README.md ARCHITECTURE.md CODE-AUDIT.md)
